...
class ReportProjectTaskUser(models.Model):
    ...
    earned_value = fields.Float(String="Earned Value", readonly=True)
    actual_cost = fields.Float(String="Actual Cost", readonly=True)
    schedule_variance = fields.Float(String="Schedule Variance", readonly=True)
    cost_variance = fields.Float(String="Cost Variance", readonly=True)
    ...
    def _from(self):
        return """
            ...
            LEFT OUTER JOIN project_task_user_rel tu on t.id=tu.task_id
            LEFT OUTER JOIN hr_employee e on e.user_id=tu.user_id
